<template>
    <nav class="relative select-none lg:flex lg:items-center w-full bg-white py-4 md:px-56">
        <div class="flex flex-wrap md:w-1/4 text-black items-center ">
        ...
        <div class="flex flex-wrap md:w-3/4 text-base lg:justify-end items-center h-12">
            ...
            <a href="#" class="inline-block text-lg ml-8 px-5 py-5 leading-none border rounded text-white bg-blue border-blue  hover:text-blue hover:bg-white mt-4 lg:mt-0">
                Get started
            </a>
        </div>
    </nav>
