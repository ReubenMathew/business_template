<template>
    ...
    <div class="container py-32 flex-wrap lg:flex md:mt-16 flex-wrap mx-auto px-5 md:px-16">
      ...
      <div class="lg:w-2/6 bg-top flex-wrap h-auto text-black py-24 px-4">
        ...
        <a href="#" class="transition duration-200 ease-in-out bg-transparent py-5 px-4 border border-blue text-blue font-bold rounded hover:bg-blue hover:text-white">Analyze your business</a>    
      </div> 
    </div>
